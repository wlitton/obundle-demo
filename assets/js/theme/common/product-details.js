...
export default class ProductDetails {
    constructor($scope, context, productAttributesData = {}) {
        ...
        const $customProductAdd = $('#customProductAdd');
        ...
        $customProductAdd.on('click', event => {
            this.addCustomProductsToCart();
        });
        ...
        this.customProducts = [
            [['product_id', '93'],['attribute[111]', '7'],['attribute[112]', '95'],['qty[]', '3']],
            [['product_id', '86'],['qty[]', '3']]
        ];
    }
    ...
    async addCustomProductsToCart() {
        var z;
        for(z=0;z<this.customProducts.length;z++) {
            var formData = new FormData();
            for(var val of this.customProducts[z]) {
            ...
            var prom = await new Promise((resolve, reject) => {
                utils.api.cart.itemAdd(formData, (err, response) => {
                    ...
                    if(z == this.customProducts.length-1) {
                        // Open preview modal and update content
                        if (this.previewModal) {
                            this.previewModal.open();
